 ...
 * @author sebgc
 */
public class MantenimientoRogacion extends javax.swing.JFrame {
    ...
    public void cargarDatos(){
     List<Rogacion> listemp = cont.listRogacion();
     for(Rogacion str: listemp){
        o[0] = str.getIntencion();
        o[1] = str.getMotivo();
        o[2] = str.getFecha();
        o[3]=str.getMisa();
...
public void llenarCombo2(){
  ...
  public void cargarDatosConFecha(){
    List<Rogacion> listemp = cont.listBusquedaRogacionConFecha(fechabusq.getDate());
    ...
    public void Resp(){
    String outputFile = "C:/Users/Parroquia San Isidro/OneDrive/Documentos-Intenciones/Respaldos/Rogacion/Rogacion_Respaldos.csv";
        ...
        List<Rogacion> listemp = cont.listRogacion();
     for(Rogacion str: listemp){
                csvOutput.write(str.getIntencion());
          ...
          public void cargarDatosSinFecha(){
            List<Rogacion> listemp = cont.listBusquedaRogacionSinFecha(busq.getSelectedItem().toString());
    ...
    JOptionPane.showMessageDialog(null, "No hay registro con esas caracteriticas");
     ...
     List<Rogacion> listemp = cont.listBusquedaRogacionCompleta(busq.getSelectedItem().toString(),fechabusq.getDate());
    ...
    private void initComponents() {
        ...
        intencion = new javax.swing.JTextField();
        ...
        jLabel12.setText("Formulario de rogación");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Intención", "Motivo", "Fecha", "Misa", "Id"
            }
        ) {
        ...
        jLabel7.setText("Mantenimiento Rogación");

        jLabel8.setText("Intención:");
        ...
        jPanel2Layout.setHorizontalGroup(
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(motivo, javax.swing.GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE)
                                        .addComponent(intencion))
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(misa, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))))
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(busq, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(50, 50, 50)
                .addComponent(jLabel14)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(fechabusq, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel8)
                                        .addComponent(intencion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
if(   "".equals(jTextField1.getText())||(jTextField1.getText().equals(X) )){
    ...
    temp3=jTextField1.getText();
}
     Rogacion rogacion=new Rogacion(TEMP2,temp3,fecha,TEMP);
      jTextField1.setText("");
     jTextField2.setText("");
      jTextField3.setText("");
 jComboBox2.setSelectedIndex(0);
 jComboBox1.setSelectedIndex(0);
     cont.agregaRogacion(rogacion); 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     filaSeleccionada = jTable1.getSelectedRow();
        if (filaSeleccionada != -1) {
            ...
            intencion.setText(jTable1.getValueAt(filaSeleccionada, 0).toString());
...
if(filaSeleccionada!=-1){
  if(fecha.getDate()==null){
   ...
   cont.actulizacionRogacionSinfecha(Integer.valueOf(jTable1.getValueAt(filaSeleccionada, 4).toString()),intencion.getText(),motivo.getText(),misa.getText());
   ...
   intencion.setText("");
     motivo.setText("");
       ...
       cont.actulizacionRogacionConfecha(Integer.valueOf(jTable1.getValueAt(filaSeleccionada, 4).toString()),intencion.getText(),motivo.getText(),fecha.getDate(),misa.getText());
    JOptionPane.showMessageDialog(null,  "Se actualizo correctamente");
     intencion.setText("");
     motivo.setText("");
         misa.setText("");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
         ...
         filaSeleccionada = jTable1.getSelectedRow();
         if(filaSeleccionada!=-1){
        cont.DeletenRogacion(Integer.valueOf(jTable1.getValueAt(filaSeleccionada, 4).toString()));
        limpiar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenimientoRogacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantenimientoRogacion().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField intencion;
